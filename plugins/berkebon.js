const timeout = 1800000
                                     ...
                                     if (global.db.data.users[m.sender].bibitmangga > 149) {
                                 	if (global.db.data.users[m.sender].bibitapel > 149) {
                                 	if (global.db.data.users[m.sender].bibitpisang > 149) {
                                 	if (global.db.data.users[m.sender].bibitjeruk > 149) {
                                 	if (global.db.data.users[m.sender].bibitanggur > 149) {
                                     ...
                                     global.db.data.users[m.sender].bibitpisang -= 150
                                     global.db.data.users[m.sender].bibitanggur -= 150
                                     global.db.data.users[m.sender].bibitmangga -= 150
                                     global.db.data.users[m.sender].bibitjeruk -= 150
                                     global.db.data.users[m.sender].bibitapel -= 150
                                     global.db.data.users[m.sender].lastberkebon = new Date * 1
                                     m.reply(`Selamat kamu mendapatkan : \n+${pisangpoin} Pisang\n+${manggapoin} Mangga\n+${anggurpoin} Anggur\n+${jerukpoin} Jeruk\n+${apelpoin} Apel\n+1 Tiketcoin`)
                                     setTimeout(() => {
					                      conn.reply(m.chat, `Waktunya berkebon lagi kak 😅`, m)
					                  }, timeout)
                                  } else m.reply(`Pastikan bibit anggur kamu *150* untuk bisa berkebon`)
                              } else m.reply(`Pastikan bibit jeruk kamu *150* untuk bisa berkebon`)
                          } else m.reply(`Pastikan bibit pisang kamu *150* untuk bisa berkebon`)
                      } else m.reply(`Pastikan bibit apel kamu *150* untuk bisa berkebon`)
                  } else m.reply(`Pastikan bibit mangga kamu *150* untuk bisa berkebon`)
              }
